...
const DB = {
    ...
    // ============================================================
    // ============================================================
    // 2. ИНДЕКСЫ (v14.1 Golden: Strict TU, Ind 23=No, No Quads)
    // ============================================================
    INDICES: [
        { id:1, n:"Взрывозащита", opts:[
            {c:"", l:"Нет (Общепром)", 
             hint:"При отсутствии требования индекс не ставится.", 
             wiki:"Общепромышленное применение."}, 
        ...
        { id:3, n:"Барьер Пары", opts:[
            {c:"", l:"Нет", hint:"Без огнестойкого барьера.", wiki:""}, 
        ...
        { id:7, n:"Водоблокировка", opts:[
            {c:"", l:"Нет", hint:"Без водоблокирующей ленты.", wiki:""}, 
        ...
        { id:8, n:"Заполнение", opts:[
            {c:"", l:"Нет", hint:"Без заполнителя.", wiki:""}, 
        ...
        { id:10, n:"Броня", opts:[
            {c:"", l:"Нет", hint:"Кабели без брони.", wiki:""}, 
        ...
        { id:12, n:"Климат", opts:[
            {c:"", l:"УХЛ", hint:"Умеренно холодный климат.", wiki:"Умеренно-холодный климат (до -50°С)."}, 
        ...
        { id:13, n:"Маслостойкость", opts:[
            {c:"", l:"Нет", hint:"Требование не предъявляется.", wiki:""}, 
            {c:"-МБ", l:"-МБ", hint:"Маслобензостойкие.", wiki:"МБ - Маслобензостойкий. Стойкость к ГСМ, дизтопливу, углеводородам."}
        ]},
        ...
        { id:16, n:"УФ / Улица", opts:[
            {c:"", l:"Нет", hint:"Требование не предъявляется.", wiki:""}, 
            {c:"-УФ", l:"-УФ", hint:"Стойкие к солнечному излучению.", wiki:"УФ - для применения на открытом воздухе (солнечная радиация)."}
        ]},
        ...
        { id:20, n:"Покрытие жилы", opts:[
            {c:"", l:"Медная проволока", hint:"Без покрытия.", wiki:"Медная мягкая проволока."}, 
        ...
        { id:21, n:"Искробезоп.", opts:[
            {c:"", l:"Нет", hint:"Общее назначение.", wiki:""}, 
